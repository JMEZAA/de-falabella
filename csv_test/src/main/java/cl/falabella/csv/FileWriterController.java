...
private Resource gcsFile;
	...
	public static void csvFile() throws IOException {
        ...
        try {
            ...
            br =new BufferedReader(new FileReader("gs://de-falabella/CSV_INPUT/GlobalLandTemperaturesByMajorCity.csv"));
            lr = br;
            ...
            for(String a : al) {
            	try {
            		...
            		fichero = new FileWriter("gs://de-falabella/CSV_OUTPUT/Archivo_Pais_\" + a + \".csv");
            		pw = new PrintWriter(fichero);  
            		List<archivo> lstfilt = ListaFiltrada(lista, a);
            		//System.out.println("Total registros " + lstfilt.size());
